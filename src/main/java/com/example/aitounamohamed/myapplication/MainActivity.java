...
/*
    public void down(int colone) {
                if (tab[3][colone].valeur != 0) {

                    if (tab[3][colone].valeur == tab[2][colone].valeur) {
                        score=score+tab[3][colone].valeur;
                        Score.setText(""+score);
                        tab[3][colone].valeur *= 2;
                        tab[2][colone].valeur = tab[1][colone].valeur ;
                        tab[1][colone].valeur = tab[0][colone].valeur ;
                        tab[0][colone].valeur = 0;
                        if(tab[2][colone].valeur==tab[1][colone].valeur)
                        {
                            score=score+tab[2][colone].valeur;
                            Score.setText(""+score);
                            tab[2][colone].valeur=2*tab[1][colone].valeur;
                            tab[1][colone].valeur=0;
                        }
                        else
                        {
                            ...
                            if(tab[3][colone].valeur==tab[1][colone].valeur){
                                ...
                                Score.setText(""+score);
                                tab[3][colone].valeur *= 2;
                                tab[2][colone].valeur = tab[0][colone].valeur;
                                tab[1][colone].valeur = 0;
                                tab[0][colone].valeur = 0;
                             }
                            else
                            ...
                            else
                            {
                                 if(tab[1][colone].valeur==0) {
                                       ...
                                       if(tab[2][colone].valeur==tab[0][colone].valeur)
                                        {
                                            score=score+tab[2][colone].valeur;
                                            Score.setText(""+score);
                                         tab[2][colone].valeur=2*tab[0][colone].valeur;
                                         tab[1][colone].valeur=0;
                                         tab[0][colone].valeur=0;
                                        }
                                     else
                                     ...
                                     if(tab[0][colone].valeur==tab[1][colone].valeur)
                                     {
                                         score=score+tab[1][colone].valeur;
                                         Score.setText(""+score);
                                         tab[1][colone].valeur=2*tab[1][colone].valeur;
                                         tab[0][colone].valeur=0;
                                     }
                                 }
                            }
                  ...
                  if(tab[2][colone].valeur==0)
                  {
                      if(tab[0][colone].valeur==tab[1][colone].valeur)
                      {
                          score=score+tab[3][colone].valeur;
                          Score.setText(""+score);
                          tab[3][colone].valeur=2*tab[1][colone].valeur;
                          tab[2][colone].valeur=0;
                          tab[0][colone].valeur=0;
                          tab[1][colone].valeur=0;
                      }
                      else
                      {
                          if(tab[1][colone].valeur==0)
                          {
                              tab[3][colone].valeur=tab[0][colone].valeur;
                              tab[2][colone].valeur=0;
                              tab[0][colone].valeur=0;
                              tab[1][colone].valeur=0;
                          }
                          else{
                          tab[3][colone].valeur=tab[1][colone].valeur;
                          tab[2][colone].valeur=tab[0][colone].valeur;
                          tab[0][colone].valeur=0;
                          tab[1][colone].valeur=0;}
                      }
                      ...
                      else
                      {
                          if(tab[1][colone].valeur==0) {
                              ...
                              if(tab[2][colone].valeur==tab[0][colone].valeur)
                              {
                                  score=score+tab[3][colone].valeur;
                                  Score.setText(""+score);
                                  tab[3][colone].valeur=2*tab[0][colone].valeur;
                                  tab[2][colone].valeur=0;
                                  tab[1][colone].valeur=0;
                                  tab[0][colone].valeur=0;
                              }
                              ...
                              {
                                  tab[3][colone].valeur=tab[2][colone].valeur;
                                  tab[2][colone].valeur=tab[0][colone].valeur;
                                  tab[1][colone].valeur=0;
                                  tab[0][colone].valeur=0;
...
/* public void up(int colone) {
        if (tab[0][colone].valeur != 0) {

            if (tab[0][colone].valeur == tab[1][colone].valeur) {
                score=score+tab[0][colone].valeur;
                Score.setText(""+score);
                tab[0][colone].valeur *= 2;
                tab[1][colone].valeur = tab[2][colone].valeur ;
                tab[2][colone].valeur = tab[3][colone].valeur ;
                tab[3][colone].valeur = 0;
                if(tab[2][colone].valeur==tab[1][colone].valeur)
                {
                    score=score+tab[1][colone].valeur;
                    Score.setText(""+score);
                    tab[1][colone].valeur=2*tab[2][colone].valeur;
                    tab[2][colone].valeur=0;
                }
                else
                {
            ...
            } else if (tab[1][colone].valeur == 0) {

                if(tab[0][colone].valeur==tab[2][colone].valeur){
                    score=score+tab[0][colone].valeur;
                    Score.setText(""+score);
                    tab[0][colone].valeur *= 2;
                    tab[1][colone].valeur = tab[3][colone].valeur;
                    tab[2][colone].valeur = 0;
                    tab[3][colone].valeur = 0;
                }
                else
                {
                    if(tab[2][colone].valeur==0)
                    {
                        if(tab[0][colone].valeur==tab[3][colone].valeur){
                            score=score+tab[0][colone].valeur;
                            Score.setText(""+score);
                            tab[0][colone].valeur *= 2;
                            tab[2][colone].valeur = 0;
                ...
                else
                {
                    if(tab[2][colone].valeur==0) {
                        ...
                        if(tab[1][colone].valeur==tab[3][colone].valeur)
                        {
                            score=score+tab[1][colone].valeur;
                            Score.setText(""+score);
                            tab[1][colone].valeur=2*tab[3][colone].valeur;
                            tab[2][colone].valeur=0;
                            tab[3][colone].valeur=0;
                        }
                        else
                        ...
                        if(tab[3][colone].valeur==tab[2][colone].valeur)
                        {
                            score=score+tab[2][colone].valeur;
                            Score.setText(""+score);
                            tab[2][colone].valeur=2*tab[2][colone].valeur;
                            tab[3][colone].valeur=0;
                        }
                    }
                }
            ...
            if(tab[1][colone].valeur==0)
            {
                if(tab[3][colone].valeur==tab[2][colone].valeur)
                {
                    score=score+tab[0][colone].valeur;
                    Score.setText(""+score);
                    tab[0][colone].valeur=2*tab[2][colone].valeur;
                    tab[1][colone].valeur=0;
                    tab[3][colone].valeur=0;
                    tab[2][colone].valeur=0;
                }
                else
                {
                    if(tab[2][colone].valeur==0)
                    {
                        tab[0][colone].valeur=tab[3][colone].valeur;
                        tab[1][colone].valeur=0;
                        tab[2][colone].valeur=0;
                        tab[3][colone].valeur=0;
                    }
                    else{
                        tab[0][colone].valeur=tab[2][colone].valeur;
                        tab[1][colone].valeur=tab[3][colone].valeur;
                        tab[2][colone].valeur=0;
                        tab[3][colone].valeur=0;}
                }
            ...
            {
                if(tab[1][colone].valeur==tab[2][colone].valeur)
                {   score=score+tab[0][colone].valeur;
                    Score.setText(""+score);
                    tab[0][colone].valeur=2*tab[2][colone].valeur;
                    tab[1][colone].valeur=tab[3][colone].valeur;
                ...
                else
                {
                    if(tab[2][colone].valeur==0) {
                        ...
                        {   score=score+tab[0][colone].valeur;
                            Score.setText(""+score);
                            tab[0][colone].valeur=2*tab[3][colone].valeur;
                            tab[1][colone].valeur=0;
                            tab[2][colone].valeur=0;
                            tab[3][colone].valeur=0;
                        }
                        ...
                        {
                            tab[0][colone].valeur=tab[1][colone].valeur;
                            tab[1][colone].valeur=tab[3][colone].valeur;
                            tab[2][colone].valeur=0;
                            tab[3][colone].valeur=0;
    ...
    public void Right(int colone) {
        if (tab[colone][3].valeur != 0) {

            if (tab[colone][3].valeur == tab[colone][2].valeur) {
                score=score+tab[colone][3].valeur;
                Score.setText(""+score);
                tab[colone][3].valeur *= 2;
                tab[colone][2].valeur = tab[colone][1].valeur ;
                tab[colone][1].valeur = tab[colone][0].valeur ;
                tab[colone][0].valeur = 0;
                if(tab[colone][2].valeur==tab[colone][1].valeur)
                {
                    score=score+tab[colone][2].valeur;
                    Score.setText(""+score);
                    tab[colone][2].valeur=2*tab[colone][1].valeur;
                    tab[colone][1].valeur=0;
                }
                else
                {
                    if(tab[colone][2].valeur==0) {
                        tab[colone][2].valeur = tab[colone][1].valeur;
                        tab[colone][1].valeur = 0;
                    }
                }

            } else if (tab[colone][2].valeur == 0) {

                if(tab[colone][3].valeur==tab[colone][1].valeur){
                    score=score+tab[colone][3].valeur;
                    Score.setText(""+score);
                    tab[colone][3].valeur *= 2;
                    tab[colone][2].valeur = tab[colone][0].valeur;
                    tab[colone][1].valeur = 0;
                    tab[colone][0].valeur = 0;
                }
                else
                {
                    if(tab[colone][1].valeur==0)
                    {
                        if(tab[colone][3].valeur==tab[colone][0].valeur){
                            score=score+tab[colone][3].valeur;
                            Score.setText(""+score);
                            tab[colone][3].valeur *= 2;
                            tab[colone][2].valeur = 0;
                            tab[colone][1].valeur = 0;
                            tab[colone][0].valeur = 0;
                        }
                        else
                        ...
                        if (tab[colone][0].valeur == tab[colone][1].valeur) {
                            score=score+tab[colone][2].valeur;
                            Score.setText(""+score);
                            tab[colone][2].valeur = 2 * tab[colone][1].valeur;
                            tab[colone][1].valeur = 0;
                ...
                else
                {
                    if(tab[colone][1].valeur==0) {
                        ...
                        if(tab[colone][2].valeur==tab[colone][0].valeur)
                        {   score=score+tab[colone][2].valeur;
                            Score.setText(""+score);
                            tab[colone][2].valeur=2*tab[colone][0].valeur;
                            tab[colone][1].valeur=0;
                            tab[colone][0].valeur=0;
                        }
                        else
                        ...
                        if(tab[colone][0].valeur==tab[colone][1].valeur)
                        {
                            score=score+tab[colone][1].valeur;
                            Score.setText(""+score);
                            tab[colone][1].valeur=2*tab[colone][1].valeur;
                            tab[colone][0].valeur=0;
                        }
                    }
                }
            ...
            if(tab[colone][2].valeur==0)
            {
                if(tab[colone][0].valeur==tab[colone][1].valeur)
                {
                    score=score+tab[colone][3].valeur;
                    Score.setText(""+score);
                    tab[colone][3].valeur=2*tab[colone][1].valeur;
                    tab[colone][2].valeur=0;
                    tab[colone][0].valeur=0;
                    tab[colone][1].valeur=0;
                }
                else
                {
                    if(tab[colone][1].valeur==0)
                    {
                        tab[colone][3].valeur=tab[colone][0].valeur;
                        tab[colone][2].valeur=0;
                        tab[colone][0].valeur=0;
                        tab[colone][1].valeur=0;
                    }
                    else{
                        tab[colone][3].valeur=tab[colone][1].valeur;
                        tab[colone][2].valeur=tab[colone][0].valeur;
                        tab[colone][0].valeur=0;
                        tab[colone][1].valeur=0;}
                }
                ...
                else
                {
                    if(tab[colone][1].valeur==0) {
                        ...
                        if(tab[colone][2].valeur==tab[colone][0].valeur)
                        {
                            score=score+tab[colone][3].valeur;
                            Score.setText(""+score);
                            tab[colone][3].valeur=2*tab[colone][0].valeur;
                            tab[colone][2].valeur=0;
                            tab[colone][1].valeur=0;
                            tab[colone][0].valeur=0;
                        }
                        ...
                        {
                            tab[colone][3].valeur=tab[colone][2].valeur;
                            tab[colone][2].valeur=tab[colone][0].valeur;
                            tab[colone][1].valeur=0;
                            tab[colone][0].valeur=0;
    ...
    public void Left(int colone) {
        if (tab[colone][0].valeur != 0) {

            if (tab[colone][0].valeur == tab[colone][1].valeur) {
                score=score+tab[colone][0].valeur;
                Score.setText(""+score);
                tab[colone][0].valeur *= 2;
                tab[colone][1].valeur = tab[colone][2].valeur ;
                tab[colone][2].valeur = tab[colone][3].valeur ;
                tab[colone][3].valeur = 0;
                if(tab[colone][2].valeur==tab[colone][1].valeur)
                {
                    score=score+tab[colone][1].valeur;
                    Score.setText(""+score);
            ...
            } else if (tab[colone][1].valeur == 0) {

                if(tab[colone][0].valeur==tab[colone][2].valeur){
                    score=score+tab[colone][0].valeur;
                    Score.setText(""+score);
                    tab[colone][0].valeur *= 2;
                    tab[colone][1].valeur = tab[colone][3].valeur;
                    tab[colone][2].valeur = 0;
                    tab[colone][3].valeur = 0;
                }
                else
                {
                    if(tab[colone][2].valeur==0)
                    {
                        if(tab[colone][3].valeur==tab[colone][0].valeur){
                            score=score+tab[colone][0].valeur;
                            Score.setText(""+score);
                            tab[colone][0].valeur = 2*tab[colone][0].valeur;
                            tab[colone][1].valeur = 0;
                            tab[colone][2].valeur = 0;
                            tab[colone][3].valeur = 0;
                        }
                        ...
                        if (tab[colone][3].valeur == tab[colone][2].valeur) {
                            score=score+tab[colone][1].valeur;
                            Score.setText(""+score);
                            tab[colone][1].valeur = 2 * tab[colone][2].valeur;
                            tab[colone][2].valeur = 0;
                            tab[colone][3].valeur = 0;
                        }
                        else {
                ...
                else
                {
                    if(tab[colone][2].valeur==0) {
                        ...
                        if(tab[colone][1].valeur==tab[colone][3].valeur)
                        {
                            score=score+tab[colone][1].valeur;
                            Score.setText(""+score);
                            tab[colone][1].valeur=2*tab[colone][3].valeur;
                            tab[colone][2].valeur=0;
                            tab[colone][3].valeur=0;
                        }
                        else
                        ...
                        if(tab[colone][3].valeur==tab[colone][2].valeur)
                        {
                            score=score+tab[colone][2].valeur;
                            Score.setText(""+score);
                            tab[colone][2].valeur=2*tab[colone][2].valeur;
                            tab[colone][3].valeur=0;
                        }
                    }
                }
            ...
            if(tab[colone][1].valeur==0)
            {
                if(tab[colone][3].valeur==tab[colone][2].valeur)
                {
                    score=score+tab[colone][0].valeur;
                    Score.setText(""+score);
                    tab[colone][0].valeur=2*tab[colone][2].valeur;
                    tab[colone][1].valeur=0;
                    tab[colone][2].valeur=0;
                    tab[colone][3].valeur=0;
                }
                else
                {
                    if(tab[colone][2].valeur==0)
                    {
                        tab[colone][0].valeur=tab[colone][3].valeur;
                        tab[colone][1].valeur=0;
                        tab[colone][2].valeur=0;
                        tab[colone][3].valeur=0;
                    }
                    else{
                        tab[colone][0].valeur=tab[colone][2].valeur;
                        tab[colone][1].valeur=tab[colone][3].valeur;
                        tab[colone][3].valeur=0;
                        tab[colone][2].valeur=0;}
                }
            ...
            {
                if(tab[colone][1].valeur==tab[colone][2].valeur)
                {
                    score=score+tab[colone][0].valeur;
                    Score.setText(""+score);
                    tab[colone][0].valeur=2*tab[colone][2].valeur;
                ...
                else
                {
                    if(tab[colone][2].valeur==0) {
                        ...
                        if(tab[colone][1].valeur==tab[colone][3].valeur)
                        {
                            score=score+tab[colone][0].valeur;
                            Score.setText(""+score);
                            tab[colone][0].valeur=2*tab[colone][3].valeur;
                            tab[colone][1].valeur=0;
                            tab[colone][2].valeur=0;
                            tab[colone][3].valeur=0;
                        }
                        ...
                        {
                            tab[colone][0].valeur=tab[colone][1].valeur;
                            tab[colone][1].valeur=tab[colone][3].valeur;
                            tab[colone][2].valeur=0;
                            tab[colone][3].valeur=0;
